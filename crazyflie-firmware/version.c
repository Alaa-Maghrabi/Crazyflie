...
const char * V_SLOCAL_REVISION="57";
const char * V_SREVISION="e1d0b3d6b3a2";
const char * V_STAG="2014.12.1-57";
const char * V_BRANCH="bigmerge";
const char * V_PROFILE=P_NAME;
const bool V_MODIFIED=true;

/* Version recoverable from the ground */
const uint32_t V_REVISION_0=0xe1d0b3d6;
const uint16_t V_REVISION_1=0xb3a2;
