 ...
 */
  ...
  #define BLMC_PERIOD 0.02   // 2.5ms = 400Hz
...
#define MOTORS_PWM_BITS1     8
#define MOTORS_PWM_PERIOD1   ((1<<MOTORS_PWM_BITS1) - 1)
#define MOTORS_PWM_PRESCALE1 0
#define MOTORS_POLARITY1           TIM_OCPolarity_High
